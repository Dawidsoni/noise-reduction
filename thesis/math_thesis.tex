...
\polishtitle    {Gradientowy algorytm Metropolis-Hastings z aplikacjami do odszumiania obrazów}
...
\noindent As it is now clear that $Q_x$ can take only $\mathcal{O}(1)$ values, we provide \textit{Algorithm}
...
\noindent As part of this thesis, we implemented \textit{Algorithm} \ref{alg:sampling_from_q} and \ref{alg:updating_q}
in Python.\ Additionally, we implemented Gibbs sampling as the baseline method.\ The results of our experiments are
